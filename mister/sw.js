const CACHE='fantasy-os-v17-fidelity';
const SHELL=['./','./index.html','./native.css','./mister-polish.css','./privacy.css','./fidelity-v17.css','./native.js','./mister-polish.js','./privacy.js','./fidelity-v17.js','./manifest.webmanifest','./icon.svg'];
