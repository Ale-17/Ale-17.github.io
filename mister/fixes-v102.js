...
function neutral(card){if(!card||card.dataset.v103Derived==='1')return;const strong=$('strong',card);if(!strong)return;strong.textContent='—';strong.classList.remove('v38-positive','v38-negative');strong.classList.add('v102-neutral')}
