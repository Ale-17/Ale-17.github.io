...
function loadV66(){if(document.querySelector('script[data-fantasy-v66]'))return;const s=document.createElement('script');s.src='./fixes-v66.js?v=66';s.dataset.fantasyV66='1';document.body.appendChild(s)}
function loadV64(){if(!document.querySelector('link[data-fantasy-v64]')){const l=document.createElement('link');l.rel='stylesheet';l.href='./fixes-v64.css?v=65';l.dataset.fantasyV64='1';document.head.appendChild(l)}const existing=document.querySelector('script[data-fantasy-v64]');if(existing){if(existing.dataset.loaded==='1')loadV66();else existing.addEventListener('load',loadV66,{once:true});return}const s=document.createElement('script');s.src='./fixes-v64.js?v=65';s.dataset.fantasyV64='1';s.addEventListener('load',()=>{s.dataset.loaded='1';loadV66()},{once:true});document.body.appendChild(s)}
